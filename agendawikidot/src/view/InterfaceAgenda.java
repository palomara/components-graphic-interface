...
import java.awt.event.ActionListener;
	...
	public InterfaceAgenda() {
		...
		pane.setLayout(null);
			...
			//define poscionamento do botão na janela
		...
		//define posicionamento do botão na janela
			...
			//define posicionamento do botão na janela
			buttonFechar.setBounds(260,  10, 90, 70);
			buttonFechar.setHorizontalTextPosition(SwingConstants.CENTER);
			buttonFechar.setVerticalAlignment(SwingConstants.BOTTOM);
		...
		//evento ao clicar no “X” de fechar a janela ao em vez do botão
